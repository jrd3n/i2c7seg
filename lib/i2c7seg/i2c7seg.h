...
class i2c7seg
{
  public:
	...
	void SegDisplay(char char1, char char2, char char3, char char4);

  private:
	char previousChars[5] = {' ', ' ', ' ', ' '};
	...
	const uint8_t SevenSegmentASCII[96] = {
		/*source https://github.com/dmadison/LED-Segment-ASCII/blob/master/7-Segment/7-Segment-ASCII_BIN.txt */
		0b00000000, /* (space) */
		0b10000110, /* ! */
		0b00100010, /* " */
		0b01111110, /* # */
